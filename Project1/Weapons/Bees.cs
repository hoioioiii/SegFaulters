...
namespace Project1
{
    ...
    public class Bees : IWeapon
    {
        ...
        public Bees((int, int) pos, ORB_DIRECTION positionDirection)
        {
            weaponType = WEAPON_TYPE.BEES;
            sprite = WeaponSpriteFactory.Instance.CreateBeesSprite((pos.Item1, pos.Item2), positionDirection);
            attackStat = 4;
        }
        public void Attack()
        {
