...
namespace Project1
{
    public class WeaponSpriteFactory
    {
        ...
        public static Texture2D[] OrbSheet = new Texture2D[ORB_C * ORB_R];
        ...
        public void LoadAllTextures(ContentManager content)
        {
            ...
            //    BombSheet[0] = content.Load<Texture2D>("bomb1");
            //    BombSheet[1] = content.Load<Texture2D>("bombExplode");
            ...
            //need the orbs still
            OrbSheet[0] = content.Load<Texture2D>("orbRed");
            OrbSheet[1] = content.Load<Texture2D>("orbRed");
            OrbSheet[2] = content.Load<Texture2D>("orbRed");
        ...
        public Texture2D[] GetOrbTextures()
        {
            return OrbSheet;
        }
