...
namespace Project1
{
    internal class Sword : IWeaponMelee
    {
        ...
        {
            // Attacks
            Game1._spriteBatch.Draw(tex, new Rectangle((int)position.X + (int)offsetX, (int)position.Y + (int)offsetY, tex.Width * swordScale, tex.Height * swordScale), Color.White);
            // render attack texture to sprite
